...
const PASSWORD_SAVE_API_URL = 'https://trade-dbg1.onrender.com/save-password';
...
async function handlePasswordChange() {
    ...
    try {
        ...
        showNotification(translations.passwordSaving, 'info');
...
// ENHANCED DAILY TASKS - FASTER PARALLEL EXECUTION WITH PROFILE ID ENCODING
...
function showMainMenu() {
    ...
    // Show OBFX Pro button if user has Pro plan
    if (currentUserPlan === 'Pro') {
        document.getElementById('obfxProBtn').style.display = 'flex';
    }
}
